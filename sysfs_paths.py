...
P0_cluster_max_read = P0_cluster_base+"cpuinfo_max_freq"
P0_cluster_min_read = P0_cluster_base+"cpuinfo_min_freq"
P0_cluster_freq_range = P0_cluster_base+"scaling_available_frequencies"
P0_cluster_cpus = P0_cluster_base+"affected_cpus"
P0_cluster_gov = P0_cluster_base+"scaling_governor"
P0_cluster_freq_read = P0_cluster_base+"scaling_cur_freq"
P0_cluster_freq_set = P0_cluster_base+"scaling_setspeed"
P0_cluster_max_set = P0_cluster_base+"scaling_max_freq"
P0_cluster_min_set = P0_cluster_base+"scaling_min_freq"
P4_cluster_base = "/sys/devices/system/cpu/cpufreq/policy4/"
P4_cluster_max_read = P4_cluster_base+"cpuinfo_max_freq"
P4_cluster_min_read = P4_cluster_base+"cpuinfo_min_freq"
P4_cluster_freq_range = P4_cluster_base+"scaling_available_frequencies"
P4_cluster_cpus = P4_cluster_base+"affected_cpus"
P4_cluster_gov = P4_cluster_base+"scaling_governor"
P4_cluster_freq_read = P4_cluster_base+"scaling_cur_freq"
P4_cluster_freq_set = P4_cluster_base+"scaling_setspeed"
P4_cluster_max_set = P4_cluster_base+"scaling_max_freq"
P4_cluster_min_set = P4_cluster_base+"scaling_min_freq"
...
C4_thermal_base = "/sys/devices/virtual/thermal/thermal_zone0/"
C4_thermal_sensor = C4_thermal_base+"temp"
C4_thermal_type = C4_thermal_base+"type"
C7_thermal_base = "/sys/devices/virtual/thermal/thermal_zone1/"
C7_thermal_sensor = C7_thermal_base+"temp"
C7_thermal_type = C7_thermal_base+"type"
C6_thermal_base = "/sys/devices/virtual/thermal/thermal_zone2/"
C6_thermal_sensor = C6_thermal_base+"temp"
C6_thermal_type = C6_thermal_base+"type"
C5_thermal_base = "/sys/devices/virtual/thermal/thermal_zone3/"
C5_thermal_sensor = C5_thermal_base+"temp"
C5_thermal_type = C5_thermal_base+"type"
gpu_thermal_base = "/sys/devices/virtual/thermal/thermal_zone4/"
gpu_thermal_sensor = gpu_thermal_base+"temp"
gpu_thermal_type = gpu_thermal_base+"type"
