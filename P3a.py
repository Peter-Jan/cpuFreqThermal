...
while(ps1-ps0<duration):
	...
	if(pstemp-ps1>=0.2):
		...
		file5 = open("data_log1/C4_temp_"+freq+".txt","a")
		file6 = open("data_log1/C5_temp_"+freq+".txt","a")
		file7 = open("data_log1/C6_temp_"+freq+".txt","a")
		file8 = open("data_log1/C7_temp_"+freq+".txt","a")
		file9 = open("data_log1/Power_"+freq+".txt","a")
		...
		file14 = open("data_log1/little_freq.txt","a")
		file15 = open("data_log1/little_volt.txt","a")
		file16 = open("data_log1/big_freq.txt","a")
		file17 = open("data_log1/big_volt.txt","a")
